...
INSERT INTO `sys_menu` (`id`, `parent_id`, `name`, `path`, `component`, `icon`, `sort`, `visible`, `redirect`, `create_time`, `update_time`, `type`, `tenant_id`) VALUES (30, 26, 'document', '', '', 'link', 1, 1, '', '2022-02-18 00:01:40', '2022-02-18 00:01:40', 3, NULL);
