...
public class TourSupervisorServiceImpl extends ServiceImpl<TourSupervisorMapper, TourSupervisor>
    ...
    private final TourSupervisorMapper tourSupervisorMapper;
    ...
    public Page<UserVO> pageSupervisor(TourSupervisorPageQuery queryParams) {
        ...
        //获取数据
        return tourSupervisorMapper.getTourSupervisor(userVOPage,queryParams);
    }
    ...
    public boolean saveSupervisor(SuperviseForm superviseForm) {
        ...
        SuperviseDomain superviseDomain = superviseDomainMapper.selectOne(new LambdaQueryWrapper<SuperviseDomain>()
        ...
        TourSupervisor tourSupervisor = tourSupervisorMapper.selectOne(new LambdaQueryWrapper<TourSupervisor>()
        ...
        if (Objects.isNull(tourSupervisor)) {
            ...
            return tourSupervisorMapper.insert(tourSupervisor)>0;
        }
        //获取到了，不可添加
    ...
    public boolean updateSupervisor(Long supervisorId, SuperviseForm superviseForm) {
        ...
        // 2022/8/11 获取用户对象
        TourSupervisor tourSupervisor = tourSupervisorMapper.selectById(supervisorId);
    ...
    public boolean deleteSupervisors(String ids) {
        ...
        return tourSupervisorMapper.deleteBatchIds(collect)>0;
    }
