...
public enum ResultCode implements  IResultCode, Serializable {
    ...
    USERNAME_OR_PASSWORD_ERROR("A0210","wrong user name or password"),//用户名或密码错误
    INPUT_PASSWORD_EXCEED_LIMIT("A0211","用户输入密码次数超限"),
    CLIENT_AUTHENTICATION_FAILED("A0212","Client authentication failed"), // 客户端认证失败*
    TOKEN_INVALID_OR_EXPIRED("A0230","Invalid or expired token"),
    VERIFICATION_INVALID_OR_EXPIRED("A0231","Invalid or expired verification"), //验证码错误

    USER_AUTHORIZED_ERROR ("A0300","访问权限异常"),
    USER_ACCESS_UNAUTHORIZED ("A0301","Access unauthorized"),
    ...
    PARAM_ERROR("P001","The parameter is incorrect"),
    SAVE_ERROR("P002","Failed to update data"),
