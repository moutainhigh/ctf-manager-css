...
import com.zdf.auth.model.vo.BPublicCheckVO;
import com.zdf.auth.service.IPublicCheckService;
import lombok.extern.slf4j.Slf4j;
import org.springframework.web.bind.annotation.RestController;
import com.baomidou.mybatisplus.core.metadata.IPage;
import com.zdf.common.constant.SysTips;
import com.zdf.common.BaseResult;
import com.zdf.auth.model.po.BPublicCheck;
...
public class BPublicCheckController {
     ...
     * @param: pageSize
     * @param: req
     * @return: com.zdf.common.BaseResult<com.baomidou.mybatisplus.core.metadata.IPage<com.zdf.auth.model.po.BPublicCheck>>
     **/
    @ApiOperation("分页查询数据")
    ...
    * @param: bPublicCheck
    * @param: req
    * @return: com.zdf.common.BaseResult<java.util.List<com.zdf.auth.model.po.BPublicCheck>>
    **/
    @ApiOperation("列表查询数据")
    ...
    **/
     ...
     * @date   2022-02-28
     * @param: id
     * @return: com.zdf.common.BaseResult<com.zdf.auth.model.po.BPublicCheckVO>
     **/
    @ApiOperation("根据id查询")
     ...
     * @param: checkForm
     * @param: req
     * @return: com.zdf.common.BaseResult<java.util.List<com.zdf.auth.model.po.BPublicCheckVO>>
     **/
    @ApiOperation("获取审核信息")
    @PostMapping("/getList")
