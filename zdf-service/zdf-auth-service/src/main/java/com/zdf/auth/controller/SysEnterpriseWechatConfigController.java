...
public class SysEnterpriseWechatConfigController {
     ...
     * @param: pageSize
     * @param: req
     * @return: com.zdf.common.BaseResult<com.baomidou.mybatisplus.core.metadata.IPage<com.zdf.auth.model.po.SysEnterpriseWechatConfig>>
     **/
    @ApiOperation("分页查询数据")
    ...
    * @param: sysEnterpriseWechatConfig
    * @param: req
    * @return: com.zdf.common.BaseResult<java.util.List<com.zdf.auth.model.po.SysEnterpriseWechatConfig>>
    **/
    @ApiOperation("列表查询数据")
    ...
    **/
     ...
     * @date   2022-02-24
     * @param: id
     * @return: com.zdf.common.BaseResult<com.zdf.auth.model.po.SysEnterpriseWechatConfig>
     **/
    @ApiOperation("根据id查询")
