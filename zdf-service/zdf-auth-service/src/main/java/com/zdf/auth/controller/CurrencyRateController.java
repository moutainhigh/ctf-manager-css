...
import com.zdf.auth.service.ICurrencyRateService;
...
public class CurrencyRateController {
     ...
     * @param: pageSize
     * @param: req
     * @return: com.zdf.common.BaseResult<com.baomidou.mybatisplus.core.metadata.IPage<com.zdf.auth.model.po.CurrencyRate>>
     **/
    @ApiOperation("分页查询数据")
    ...
    * @param: currencyRate
    * @param: req
    * @return: com.zdf.common.BaseResult<java.util.List<com.zdf.auth.model.po.CurrencyRate>>
    **/
    @ApiOperation("列表查询数据")
    ...
    **/
     ...
     * @date   2022-04-11
     * @param: id
     * @return: com.zdf.common.BaseResult<com.zdf.auth.model.po.CurrencyRate>
     **/
    @ApiOperation("根据id查询")
