...
public class SysWechatConfigController {
     ...
     * @param: pageSize
     * @param: req
     * @return: com.zdf.common.BaseResult<com.baomidou.mybatisplus.core.metadata.IPage<com.zdf.auth.model.po.SysWechatConfig>>
     **/
    @ApiOperation("分页查询数据")
    ...
    * @param: sysWechatConfig
    * @param: req
    * @return: com.zdf.common.BaseResult<java.util.List<com.zdf.auth.model.po.SysWechatConfig>>
    **/
    @ApiOperation("列表查询数据")
