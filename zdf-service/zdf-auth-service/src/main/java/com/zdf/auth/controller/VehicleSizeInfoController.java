...
public class VehicleSizeInfoController {
     ...
     * @param: pageSize
     * @param: req
     * @return: com.zdf.common.BaseResult<com.baomidou.mybatisplus.core.metadata.IPage<com.zdf.auth.model.po.VehicleSizeInfo>>
     **/
    @ApiOperation("分页查询数据")
    ...
    * @param: vehicleSizeInfo
    * @param: req
    * @return: com.zdf.common.BaseResult<java.util.List<com.zdf.auth.model.po.VehicleSizeInfo>>
    **/
    @ApiOperation("列表查询数据")
    ...
    **/
     ...
     * @date   2022-04-11
     * @param: id
     * @return: com.zdf.common.BaseResult<com.zdf.auth.model.po.VehicleSizeInfo>
     **/
    @ApiOperation("根据id查询")
    ...
    public CommonResult<List<InitComboxStrVO>> initVehicleSize() {
        ...
        List<com.zdf.common.entity.InitComboxStrVO> cabinetSizes = new ArrayList<>();
        for (VehicleSizeInfo obj : vehicleSizeInfoVOS) {
            com.zdf.common.entity.InitComboxStrVO initComboxVO = new com.zdf.common.entity.InitComboxStrVO();
