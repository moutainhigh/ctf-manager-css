...
public interface ISysEnterpriseWechatConfigService extends IService<SysEnterpriseWechatConfig> {
     ...
     * @param: pageSize
     * @param: req
     * @return: com.baomidou.mybatisplus.core.metadata.IPage<com.zdf.auth.model.po.SysEnterpriseWechatConfig>
     **/
     ...
     * @param: sysEnterpriseWechatConfig
     * @param: req
     * @return: java.util.List<com.zdf.auth.model.po.SysEnterpriseWechatConfig>
     **/
