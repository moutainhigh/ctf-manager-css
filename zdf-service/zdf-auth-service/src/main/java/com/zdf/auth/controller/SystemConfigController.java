...
public class SystemConfigController {
     ...
     * @param: pageSize
     * @param: req
     * @return: com.zdf.common.BaseResult<com.baomidou.mybatisplus.core.metadata.IPage<com.zdf.auth.model.po.SystemConfig>>
     **/
    @ApiOperation("分页查询数据")
    ...
    * @param: systemConfig
    * @param: req
    * @return: com.zdf.common.BaseResult<java.util.List<com.zdf.auth.model.po.SystemConfig>>
    **/
    @ApiOperation("列表查询数据")
    ...
    **/
     ...
     * @date   2022-03-23
     * @param: id
     * @return: com.zdf.common.BaseResult<com.zdf.auth.model.po.SystemConfig>
     **/
    @ApiOperation("根据id查询")
