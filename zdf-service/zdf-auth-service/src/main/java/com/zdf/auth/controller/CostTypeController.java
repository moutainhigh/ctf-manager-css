...
import com.zdf.auth.model.bo.AddCostTypeForm;
import com.zdf.auth.model.bo.QueryCostTypeForm;
...
import com.zdf.common.constant.SqlConstant;
...
public class CostTypeController {
     ...
     * @param: pageSize
     * @param: req
     * @return: com.zdf.common.BaseResult<com.baomidou.mybatisplus.core.metadata.IPage<com.zdf.auth.model.po.CostType>>
     **/
    @ApiOperation("分页查询数据")
    ...
    * @param: costType
    * @param: req
    * @return: com.zdf.common.BaseResult<java.util.List<com.zdf.auth.model.po.CostType>>
    **/
    @ApiOperation("列表查询数据")
    ...
    **/
     ...
     * @date   2022-04-11
     * @param: id
     * @return: com.zdf.common.BaseResult<com.zdf.auth.model.po.CostType>
     **/
    @ApiOperation("根据id查询")
