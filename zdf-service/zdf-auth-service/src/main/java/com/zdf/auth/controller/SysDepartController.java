...
public class SysDepartController {
     ...
     * @param: pageSize
     * @param: req
     * @return: com.zdf.common.BaseResult<com.baomidou.mybatisplus.core.metadata.IPage<com.zdf.auth.model.po.SysDepart>>
     **/
    @ApiOperation("分页查询数据")
    ...
    * @param: sysDepart
    * @param: req
    * @return: com.zdf.common.BaseResult<java.util.List<com.zdf.auth.model.po.SysDepart>>
    **/
    @ApiOperation("列表查询数据")
...
//    }
     ...
     * @date   2022-02-22
     * @param: id
     * @return: com.zdf.common.BaseResult<com.zdf.auth.model.po.SysDepart>
     **/
    @ApiOperation("根据id查询")
