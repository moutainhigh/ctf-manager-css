...
import com.zdf.common.ApiResult;
...
public class CurrencyInfoController {
     ...
     * @param: pageSize
     * @param: req
     * @return: com.zdf.common.BaseResult<com.baomidou.mybatisplus.core.metadata.IPage<com.zdf.auth.model.po.CurrencyInfo>>
     **/
    @ApiOperation("分页查询数据")
    ...
    * @param: currencyInfo
    * @param: req
    * @return: com.zdf.common.BaseResult<java.util.List<com.zdf.auth.model.po.CurrencyInfo>>
    **/
    @ApiOperation("列表查询数据")
    ...
    **/
     ...
     * @date   2022-04-11
     * @param: id
     * @return: com.zdf.common.BaseResult<com.zdf.auth.model.po.CurrencyInfo>
     **/
    @ApiOperation("根据id查询")
