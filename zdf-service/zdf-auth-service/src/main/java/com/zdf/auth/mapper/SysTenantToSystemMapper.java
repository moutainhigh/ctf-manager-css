...
public interface SysTenantToSystemMapper extends BaseMapper<SysTenantToSystem> {
     ...
     * @return: com.baomidou.mybatisplus.core.metadata.IPage<com.zdf.auth.model.po.SysTenantToSystem>
     **/
     ...
     * @date   2022-02-21
     * @param: sysTenantToSystem
     * @return: java.util.List<com.zdf.auth.model.po.SysTenantToSystem>
     **/
