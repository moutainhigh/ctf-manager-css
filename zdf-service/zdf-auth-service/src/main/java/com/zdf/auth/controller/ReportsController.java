...
public class ReportsController {
     ...
     * @param: pageSize
     * @param: req
     * @return: com.zdf.common.BaseResult<com.baomidou.mybatisplus.core.metadata.IPage<com.zdf.auth.model.po.Reports>>
     **/
    @ApiOperation("分页查询数据")
    ...
    * @param: reports
    * @param: req
    * @return: com.zdf.common.BaseResult<java.util.List<com.zdf.auth.model.po.Reports>>
    **/
    @ApiOperation("列表查询数据")
    ...
    **/
     ...
     * @date   2022-04-25
     * @param: id
     * @return: com.zdf.common.BaseResult<com.zdf.auth.model.po.Reports>
     **/
    @ApiOperation("根据id查询")
