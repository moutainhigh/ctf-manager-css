...
//            doLog(commonResult);
    ...
    public void vivoAirListener(ConsumerRecord<?, ?> record) throws IOException {
        ...
        if (match(com.ctf.common.enums.KafkaMsgEnums.VIVO_FREIGHT_AIR_MESSAGE_ONE, record)) {
        ...
        if (match(com.ctf.common.enums.KafkaMsgEnums.VIVO_FREIGHT_AIR_MESSAGE_TWO, record)) {
        ...
        if (match(com.ctf.common.enums.KafkaMsgEnums.VIVO_FREIGHT_AIR_MESSAGE_THREE, record)) {
        ...
        if (match(com.ctf.common.enums.KafkaMsgEnums.VIVO_FREIGHT_AIR_MESSAGE_FOUR, record)) {
    ...
    public void vivoTmsListener(ConsumerRecord<?, ?> record) throws IOException {
        ...
        if (match(com.ctf.common.enums.KafkaMsgEnums.VIVO_FREIGHT_TMS_MESSAGE_ONE, record)) {
    ...
    public void sendEmailListener(ConsumerRecord<?, ?> record) throws IOException {
        ...
        if (match(com.ctf.common.enums.KafkaMsgEnums.CUSTOM_SEND_EMAIL, record)) {
...
//                kafkaTemplate.send(topic, key, value);
    ...
    public void msgPushListener(ConsumerRecord<?, ?> record) {
        ...
        if (match(com.ctf.common.enums.KafkaMsgEnums.MESSAGE_PUSH_TASK, record)) {
            log.info("消息推送...");
    ...
    private Boolean match(com.ctf.common.enums.KafkaMsgEnums enums, ConsumerRecord<?, ?> record) {
        if (Objects.equals(enums.getTopic(), record.topic()) && Objects.equals(enums.getKey(), record.key())) {
            return true;
        }
        return false;
