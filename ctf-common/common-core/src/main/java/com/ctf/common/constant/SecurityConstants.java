...
public interface SecurityConstants {
     ...
     * 系统管理 web 客户端ID
     */
    String ADMIN_CLIENT_ID = "ctf-admin-web";

    /**
     * 移动端（H5/Android/IOS）客户端ID
     */
    String APP_CLIENT_ID = "ctf-app";

    /**
     * 微信小程序客户端ID
     */
    String WEAPP_CLIENT_ID = "ctf-weapp";


    /**
     * 线上环境放行的请求路径
     */
    List<String> PROD_PERMIT_PATHS= Arrays.asList("/ctf-lab","/app-api","/ctf-auth/oauth/logout");

    /**
     * 线上环境禁止的请求路径
     */
    List<String> PROD_FORBID_PATHS= Arrays.asList("/ctf-admin/api/v1/menus","/ex-pms/api");
