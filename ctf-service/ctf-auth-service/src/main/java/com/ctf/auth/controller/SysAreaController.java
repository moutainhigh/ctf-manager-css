...
import com.ctf.auth.service.ISysAreaService;
...
public class SysAreaController {
     ...
     * @param: pageSize
     * @param: req
     * @return: com.ctf.common.BaseResult<com.baomidou.mybatisplus.core.metadata.IPage < com.ctf.auth.model.po.SysArea>>
     **/
    @ApiOperation("分页查询数据")
     ...
     * @param: sysArea
     * @param: req
     * @return: com.ctf.common.BaseResult<java.util.List < com.ctf.auth.model.po.SysArea>>
     **/
    @ApiOperation("列表查询数据")
     ...
     * @date 2022-02-26
     * @param: id
     * @return: com.ctf.common.BaseResult<com.ctf.auth.model.po.SysArea>
     **/
    @ApiOperation("根据id查询")
