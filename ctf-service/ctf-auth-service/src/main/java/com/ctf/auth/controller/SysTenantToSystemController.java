...
public class SysTenantToSystemController {
     ...
     * @param: pageSize
     * @param: req
     * @return: com.ctf.common.BaseResult<com.baomidou.mybatisplus.core.metadata.IPage<com.ctf.auth.model.po.SysTenantToSystem>>
     **/
    @ApiOperation("分页查询数据")
    ...
    * @param: sysTenantToSystem
    * @param: req
    * @return: com.ctf.common.BaseResult<java.util.List<com.ctf.auth.model.po.SysTenantToSystem>>
    **/
    @ApiOperation("列表查询数据")
    ...
    **/
     ...
     * @date   2022-02-21
     * @param: id
     * @return: com.ctf.common.BaseResult<com.ctf.auth.model.po.SysTenantToSystem>
     **/
    @ApiOperation("根据id查询")
