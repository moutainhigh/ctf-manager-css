...
import com.ctf.auth.mapper.SysUserRoleMapper;
    ...
    public boolean saveOrUpdateSysUser(SysUserForm sysUserForm) {
        ...
        if (sysUser.getId() != null) {
            ...
            if (sysUserForm.getDepartIdLists().size() != 0) {
                fileNameString = com.ctf.common.utils.StringUtils.getFileNameString(sysUserForm.getDepartIdLists());
            }
            //负责部门节点id集合
...
//            }
            ...
            //负责部门节点id集合
            sysUser.setDepartmentList(fileNameString);
            if (com.ctf.common.utils.StringUtils.isEmpty(sysUser.getPassword())) {
                //设置默认密码
