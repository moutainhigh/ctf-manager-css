...
public class SysUrlController {
     ...
     * @param: pageSize
     * @param: req
     * @return: com.ctf.common.BaseResult<com.baomidou.mybatisplus.core.metadata.IPage<com.ctf.auth.model.po.SysUrl>>
     **/
    @ApiOperation("分页查询数据")
    ...
    * @param: sysUrl
    * @param: req
    * @return: com.ctf.common.BaseResult<java.util.List<com.ctf.auth.model.po.SysUrl>>
    **/
    @ApiOperation("列表查询数据")
    ...
    **/
     ...
     * @date   2022-02-21
     * @param: id
     * @return: com.ctf.common.BaseResult<com.ctf.auth.model.po.SysUrl>
     **/
    @ApiOperation("根据id查询")
