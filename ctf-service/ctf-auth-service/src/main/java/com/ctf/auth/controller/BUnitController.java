...
public class BUnitController {
     ...
     * @param: pageSize
     * @param: req
     * @return: com.ctf.common.BaseResult<com.baomidou.mybatisplus.core.metadata.IPage<com.ctf.auth.model.po.BUnit>>
     **/
    @ApiOperation("分页查询数据")
    ...
    * @param: bUnit
    * @param: req
    * @return: com.ctf.common.BaseResult<java.util.List<com.ctf.auth.model.po.BUnit>>
    **/
    @ApiOperation("列表查询数据")
    ...
    **/
     ...
     * @date   2022-03-25
     * @param: id
     * @return: com.ctf.common.BaseResult<com.ctf.auth.model.po.BUnit>
     **/
    @ApiOperation("根据id查询")
