...
import com.ctf.auth.service.IAirPortService;
import com.ctf.auth.model.po.AirPort;
...
public class AirPortController {
     ...
     * @param: pageSize
     * @param: req
     * @return: com.ctf.common.BaseResult<com.baomidou.mybatisplus.core.metadata.IPage<com.ctf.auth.model.po.AirPort>>
     **/
    @ApiOperation("分页查询数据")
    ...
    * @param: airPort
    * @param: req
    * @return: com.ctf.common.BaseResult<java.util.List<com.ctf.auth.model.po.AirPort>>
    **/
    @ApiOperation("列表查询数据")
    ...
    **/
     ...
     * @date   2022-03-24
     * @param: id
     * @return: com.ctf.common.BaseResult<com.ctf.auth.model.po.AirPort>
     **/
    @ApiOperation("根据id查询")
