...
public class SysTenantRoleController {
     ...
     * @param: pageSize
     * @param: req
     * @return: com.ctf.common.BaseResult<com.baomidou.mybatisplus.core.metadata.IPage<com.ctf.auth.model.po.SysTenantRole>>
     **/
    @ApiOperation("分页查询数据")
    ...
    * @param: sysTenantRole
    * @param: req
    * @return: com.ctf.common.BaseResult<java.util.List<com.ctf.auth.model.po.SysTenantRole>>
    **/
    @ApiOperation("列表查询数据")
    ...
    **/
     ...
     * @date   2022-03-05
     * @param: id
     * @return: com.ctf.common.BaseResult<com.ctf.auth.model.po.SysTenantRole>
     **/
    @ApiOperation("根据id查询")
