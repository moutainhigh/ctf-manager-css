...
public class SysPostController {
     ...
     * @param: pageSize
     * @param: req
     * @return: com.ctf.common.BaseResult<com.baomidou.mybatisplus.core.metadata.IPage<com.ctf.auth.model.po.SysPost>>
     **/
    @ApiOperation("分页查询数据")
    ...
    * @param: sysPost
    * @param: req
    * @return: com.ctf.common.BaseResult<java.util.List<com.ctf.auth.model.po.SysPost>>
    **/
    @ApiOperation("列表查询数据")
...
//        sysPostService.deleteSysPost(ids.getIds());
     ...
     * @date   2022-02-22
     * @param: id
     * @return: com.ctf.common.BaseResult<com.ctf.auth.model.po.SysPost>
     **/
    @ApiOperation("根据id查询")
