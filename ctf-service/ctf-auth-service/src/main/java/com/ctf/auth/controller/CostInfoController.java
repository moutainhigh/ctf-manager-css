...
import com.ctf.auth.model.bo.AddCostInfoForm;
import com.ctf.auth.model.bo.QueryCostInfoForm;
import com.ctf.auth.model.enums.StatusEnum;
import com.ctf.auth.model.po.CurrencyInfo;
import com.ctf.auth.model.vo.CostInfoVO;
...
public class CostInfoController {
     ...
     * @param: pageSize
     * @param: req
     * @return: com.ctf.common.BaseResult<com.baomidou.mybatisplus.core.metadata.IPage<com.ctf.auth.model.po.CostInfo>>
     **/
    @ApiOperation("分页查询数据")
    ...
    * @param: costInfo
    * @param: req
    * @return: com.ctf.common.BaseResult<java.util.List<com.ctf.auth.model.po.CostInfo>>
    **/
    @ApiOperation("列表查询数据")
    ...
    **/
     ...
     * @date   2022-04-11
     * @param: id
     * @return: com.ctf.common.BaseResult<com.ctf.auth.model.po.CostInfo>
     **/
    @ApiOperation("根据id查询")
