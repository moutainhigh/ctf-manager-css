...
public class CostGenreController {
     ...
     * @param: pageSize
     * @param: req
     * @return: com.ctf.common.BaseResult<com.baomidou.mybatisplus.core.metadata.IPage<com.ctf.auth.model.po.CostGenre>>
     **/
    @ApiOperation("分页查询数据")
    ...
    * @param: costGenre
    * @param: req
    * @return: com.ctf.common.BaseResult<java.util.List<com.ctf.auth.model.po.CostGenre>>
    **/
    @ApiOperation("列表查询数据")
    ...
    **/
     ...
     * @date   2022-04-11
     * @param: id
     * @return: com.ctf.common.BaseResult<com.ctf.auth.model.po.CostGenre>
     **/
    @ApiOperation("根据id查询")
