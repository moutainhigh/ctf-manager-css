...
import com.ctf.auth.service.ISysTenantService;
...
public class SysTenantController {
     ...
     * @param: pageSize
     * @param: req
     * @return: com.ctf.common.BaseResult<com.baomidou.mybatisplus.core.metadata.IPage<com.ctf.auth.model.po.SysTenant>>
     **/
    @ApiOperation("分页查询数据")
    ...
    * @param: sysTenant
    * @param: req
    * @return: com.ctf.common.BaseResult<java.util.List<com.ctf.auth.model.po.SysTenant>>
    **/
    @ApiOperation("列表查询数据")
    ...
    **/
     ...
     * @date   2022-02-22
     * @param: id
     * @return: com.ctf.common.BaseResult<com.ctf.auth.model.po.SysTenant>
     **/
    @ApiOperation("根据id查询")
