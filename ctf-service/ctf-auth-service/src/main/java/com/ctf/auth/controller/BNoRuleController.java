...
import com.ctf.auth.service.IBNoRuleService;
...
public class BNoRuleController {
     ...
     * @param: pageSize
     * @param: req
     * @return: com.ctf.common.BaseResult<com.baomidou.mybatisplus.core.metadata.IPage<com.ctf.auth.model.po.BNoRule>>
     **/
    @ApiOperation("分页查询数据")
    ...
    * @param: bNoRule
    * @param: req
    * @return: com.ctf.common.BaseResult<java.util.List<com.ctf.auth.model.po.BNoRule>>
    **/
    @ApiOperation("列表查询数据")
    ...
    **/
     ...
     * @date   2022-03-01
     * @param: id
     * @return: com.ctf.common.BaseResult<com.ctf.auth.model.po.BNoRule>
     **/
    @ApiOperation("根据id查询")
