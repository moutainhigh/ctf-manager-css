...
import com.ctf.common.dto.QuerySysLogForm;
...
public class SysLogController {
     ...
     * @param: pageSize
     * @param: req
     * @return: com.ctf.common.BaseResult<com.baomidou.mybatisplus.core.metadata.IPage < com.ctf.auth.model.po.SysLog>>
     **/
    @ApiOperation("分页查询数据")
     ...
     * @param: sysLog
     * @param: req
     * @return: com.ctf.common.BaseResult<java.util.List < com.ctf.auth.model.po.SysLog>>
     **/
    @ApiOperation("列表查询数据")
     ...
     * @date 2022-03-22
     * @param: id
     * @return: com.ctf.common.BaseResult<com.ctf.auth.model.po.SysLog>
     **/
    @ApiOperation("根据id查询")
