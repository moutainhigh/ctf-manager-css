...
import com.ctf.auth.service.ISysDictService;
...
public class SysDictController {
     ...
     * @param: pageSize
     * @param: req
     * @return: com.ctf.common.BaseResult<com.baomidou.mybatisplus.core.metadata.IPage < com.ctf.auth.model.po.SysDict>>
     **/
    @ApiOperation("分页查询数据")
     ...
     * @param: sysDict
     * @param: req
     * @return: com.ctf.common.BaseResult<java.util.List < com.ctf.auth.model.po.SysDict>>
     **/
    @ApiOperation("列表查询数据")
...
//    }
     ...
     * @date 2022-02-23
     * @param: id
     * @return: com.ctf.common.BaseResult<com.ctf.auth.model.po.SysDict>
     **/
    @ApiOperation("根据id查询")
