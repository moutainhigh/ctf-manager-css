...
import com.ctf.common.entity.TreeNode;
import com.ctf.common.utils.TreeUtil;
...
import com.ctf.auth.service.IRegionCityService;
...
public class RegionCityController {
     ...
     * @param: pageSize
     * @param: req
     * @return: com.ctf.common.BaseResult<com.baomidou.mybatisplus.core.metadata.IPage<com.ctf.auth.model.po.RegionCity>>
     **/
    @ApiOperation("分页查询数据")
    ...
    * @param: regionCity
    * @param: req
    * @return: com.ctf.common.BaseResult<java.util.List<com.ctf.auth.model.po.RegionCity>>
    **/
    @ApiOperation("列表查询数据")
    ...
    **/
     ...
     * @date   2022-04-11
     * @param: id
     * @return: com.ctf.common.BaseResult<com.ctf.auth.model.po.RegionCity>
     **/
    @ApiOperation("根据id查询")
