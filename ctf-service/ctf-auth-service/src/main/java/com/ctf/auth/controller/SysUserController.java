...
import com.ctf.auth.model.bo.SysUserForm;
import com.ctf.auth.model.dto.SysUserDTO;
...
import com.ctf.common.utils.Captcha;
import com.ctf.common.utils.CreateImageCode;
...
public class SysUserController {
     ...
     * @param: pageSize
     * @param: req
     * @return: com.ctf.common.BaseResult<com.baomidou.mybatisplus.core.metadata.IPage < com.ctf.auth.model.po.SysUser>>
     **/
    @ApiOperation("分页查询数据")
     ...
     * @param: sysUser
     * @param: req
     * @return: com.ctf.common.BaseResult<java.util.List < com.ctf.auth.model.po.SysUser>>
     **/
    @ApiOperation("列表查询数据")
...
//    }
     ...
     * @date 2022-02-21
     * @param: id
     * @return: com.ctf.common.BaseResult<com.ctf.auth.model.po.SysUser>
     **/
    @ApiOperation("根据id查询")
