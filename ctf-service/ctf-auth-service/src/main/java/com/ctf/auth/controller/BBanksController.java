...
public class BBanksController {
     ...
     * @param: pageSize
     * @param: req
     * @return: com.ctf.common.BaseResult<com.baomidou.mybatisplus.core.metadata.IPage<com.ctf.auth.model.po.BBanks>>
     **/
    @ApiOperation("分页查询数据")
    ...
    * @param: bBanks
    * @param: req
    * @return: com.ctf.common.BaseResult<java.util.List<com.ctf.auth.model.po.BBanks>>
    **/
    @ApiOperation("列表查询数据")
    ...
    **/
     ...
     * @date   2022-04-22
     * @param: id
     * @return: com.ctf.common.BaseResult<com.ctf.auth.model.po.BBanks>
     **/
    @ApiOperation("根据id查询")
