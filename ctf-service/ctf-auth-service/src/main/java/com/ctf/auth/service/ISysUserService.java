...
public interface ISysUserService extends IService<SysUser> {
     ...
     * @param: pageSize
     * @param: req
     * @return: com.baomidou.mybatisplus.core.metadata.IPage<com.ctf.auth.model.po.SysUser>
     **/
     ...
     * @param: sysUser
     * @param: req
     * @return: java.util.List<com.ctf.auth.model.po.SysUser>
     **/
     ...
     * @date   2022/3/3 9:52
     * @param: roleCode
     * @return: java.util.List<com.ctf.auth.model.dto.SysUserDto>
     **/
     ...
     * @date   2022/3/5 10:17
     * @param: username
     * @return: com.ctf.auth.model.dto.SysUserDTO
     **/
