...
import com.ctf.auth.model.bo.SysRoleActionCheckForm;
...
import com.ctf.auth.service.ISysRoleActionCheckService;
...
public class SysRoleActionCheckController {
     ...
     * @param: pageSize
     * @param: req
     * @return: com.ctf.common.BaseResult<com.baomidou.mybatisplus.core.metadata.IPage<com.ctf.auth.model.po.SysRoleActionCheck>>
     **/
    @ApiOperation("分页查询数据")
    ...
    * @param: sysRoleActionCheck
    * @param: req
    * @return: com.ctf.common.BaseResult<java.util.List<com.ctf.auth.model.po.SysRoleActionCheck>>
    **/
    @ApiOperation("列表查询数据")
    ...
    **/
     ...
     * @date   2022-03-01
     * @param: id
     * @return: com.ctf.common.BaseResult<com.ctf.auth.model.po.SysRoleActionCheck>
     **/
    @ApiOperation("根据id查询")
