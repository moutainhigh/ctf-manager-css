...
public interface ISysEnterpriseDingdingConfigService extends IService<SysEnterpriseDingdingConfig> {
     ...
     * @param: pageSize
     * @param: req
     * @return: com.baomidou.mybatisplus.core.metadata.IPage<com.ctf.auth.model.po.SysEnterpriseDingdingConfig>
     **/
     ...
     * @param: sysEnterpriseDingdingConfig
     * @param: req
     * @return: java.util.List<com.ctf.auth.model.po.SysEnterpriseDingdingConfig>
     **/
